...
const installations = [
  ...
  },
  {
    ...
    marqueOnduleur: "Enphase",
    marquePanneaux: "LONGi",
  },
  {
    id: 7,
    date: "01/2023",
  ...
  },
  {
    ...
    marqueOnduleur: "SolarEdge",
    marquePanneaux: "Yingli",
  },
  {
    id: 9,
    date: "08/2023",
  ...
  },
  {
    ...
    marqueOnduleur: "Omnik",
    marquePanneaux: "Panasonic",
  },
  {
    id: 11,
    date: "06/2023",
    ...
    marqueOnduleur: "Victron",
    marquePanneaux: "First Solar",
  },
  {
    id: 12,
    date: "10/2022",
    ...
    marqueOnduleur: "APSystems",
    marquePanneaux: "Phono Solar",
  },
  {
    id: 13,
    date: "09/2023",
    ...
    marqueOnduleur: "Solax",
    marquePanneaux: "Sharp",
  },
  {
    id: 14,
    date: "07/2021",
    ...
    marqueOnduleur: "Ginlong",
    marquePanneaux: "Axitec",
  },
  {
    id: 15,
    date: "05/2020",
    ...
    marqueOnduleur: "GoodWe",
    marquePanneaux: "ZNSHINE",
  },
  {
    id: 16,
    date: "03/2023",
    ...
    marqueOnduleur: "Mastervolt",
    marquePanneaux: "Solarwatt",
  },
  {
    id: 17,
    date: "02/2022",
    ...
    surface: 28,
    puissance: 3.6,
    localisation: "Saint-Denis (974)",
    marqueOnduleur: "AEconversion",
    marquePanneaux: "QCells",
  },
  {
    id: 18,
...
selectes.forEach((select) => {
  select.addEventListener("change", () => {
    ...
    currentData = installations.filter((item) => {
      return (
        (!filtreOnduleur || item.marqueOnduleur === filtreOnduleur) &&
        (!filtrePanneaux || item.marquePanneaux === filtrePanneaux) &&
        (!filtreDepartement ||
          item.localisation.includes(`(${filtreDepartement})`))
      );
    });
    currentPage = 1;
    afficherResultats(currentData, currentPage);
